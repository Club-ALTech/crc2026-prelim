...
def test_from_problem_description():
    assert part_3("Platypus is the best animal in the world.") == [
        36,
        37,
        22,
        9,
    ...
    assert part_3(
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur hendrerit nulla suscipit quy rhoncus luctus. Curabitur in ex est. Aenean non sollicitudin nulla"
    ) == [1, 2, 30, 6, 20, 67, 13, 16, 94, 48, 92, 9, 3]

    assert part_3("What exactly is that thing called an ornithorynque in french??") == [
        37,
        38,
        24,
        13,
...
def test_supplementaire():
    ...
    ) == [13, 6, 3, 10, 44, 1, 23, 61, 64, 20, -1, 38, 2]
